...
if("TRUE" STREQUAL "TRUE")
  set(panda_control_SOURCE_PREFIX /home/ubuntuuser/panda_tictactoe_ws/src/panda_control)
  set(panda_control_DEVEL_PREFIX /home/ubuntuuser/panda_tictactoe_ws/devel)
  ...
  set(panda_control_INSTALL_PREFIX /home/ubuntuuser/panda_tictactoe_ws/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'ubuntuuser <ubuntuuser@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'panda_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntuuser/panda_tictactoe_ws/src/panda_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntuuser/panda_tictactoe_ws/devel/lib;/home/ubuntuuser/panda_tictactoe_ws/devel/lib;/opt/ros/melodic/lib)
